...
class AdminInputMoneyScreen extends StatefulWidget {
  const AdminInputMoneyScreen({super.key});

  @override
  State<AdminInputMoneyScreen> createState() => _AdminInputMoneyScreenState();
}

class _AdminInputMoneyScreenState extends State<AdminInputMoneyScreen> {
