...
class MemberRecentActivityScreen extends StatefulWidget {
  const MemberRecentActivityScreen({super.key});

  @override
  State<MemberRecentActivityScreen> createState() =>
      _MemberRecentActivityScreenState();
}

class _MemberRecentActivityScreenState
    extends State<MemberRecentActivityScreen> {
  List _get = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   onPressed: () {
      //     Navigator.pushReplacementNamed(context, '/MemberTableScreen');
      //   },
