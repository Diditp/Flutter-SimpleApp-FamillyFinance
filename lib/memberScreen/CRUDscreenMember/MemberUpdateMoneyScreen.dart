...
class MemberUpdateScreen extends StatefulWidget {
  MemberUpdateScreen({super.key, required this.id});
  String id;
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          "http://192.168.1.8/familly_finance/php/detail_history.php?id_keuangan='${widget.id}'"));
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          tanggal = TextEditingController(text: data['tanggal']);
          keterangan = TextEditingController(text: data['keterangan']);
          pemasukan = TextEditingController(text: data['pemasukan']);
          pengeluaran = TextEditingController(text: data['pengeluaran']);
        });
      }
    } catch (e) {
      print(e);
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse(
            "http://192.168.1.8/familly_finance/php/updateTransaksi.php?id_keuangan='${widget.id}'"),
        body: {
          "id_keuangan": widget.id,
          "nama": nama.text,
  ...
  Future _onDelete(context) async {
    try {
      return await http.delete(
        Uri.parse(
            "http://192.168.1.8/familly_finance/php/deleteTransaksi.php?id_keuangan='${widget.id}'"),
        body: {
          "id_keuangan": widget.id,
        },
      ).then((value) {
