...
import 'package:familly_finance/models/CardModel.dart';
import 'package:flutter/material.dart';

class HomeMemberScreen extends StatefulWidget {
  const HomeMemberScreen({super.key, required this.username});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/UserAcountScreen');
        },
